...
# ---- solve NLP              ------
opts = {};
opts["ipopt"] = dict(max_iter=5000, print_level=0)
...
plt.savefig("figures/P3_position_with_sigma_max_{}_delta_v_{}.png".format(sigma_max,delta_v), dpi=300)
...
plt.minorticks_on()
plt.grid(visible=True, which="both", linestyle=":")
plt.savefig("figures/P3_velocity_with_sigma_max_{}_delta_v_{}.png".format(sigma_max,delta_v), dpi=300)
...
plt.minorticks_on()
plt.grid(visible=True, which="both", linestyle=":")
plt.savefig("figures/P3_thrust_acceleration_with_sigma_max_{}_delta_v_{}.png".format(sigma_max,delta_v), dpi=300)
plt.show()